                ...
                <View style={styles.container}>
                    <Animated.View entering={FadeInLeft.delay(200).springify()}>
                        <Pressable style={styles.iconTxtContainer}>
                            <Feather name='star' size={30} color={'#CE54E5'} />
